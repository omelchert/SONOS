...
def main():
        ...
        c0     = 150000.
        z10, z11, ma1  = 0.00, 0.05, 20.0
        z20, z21, ma2  = 0.05, 0.10, 10.0
        ...
        p_zD_t   = OASignal((zD,rhoD),(z,dz,S_z),(rho,drho,phi,dphi,iProf),dr)
